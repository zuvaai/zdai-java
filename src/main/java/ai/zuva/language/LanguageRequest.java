...
public class LanguageRequest extends BaseRequest {
     ...
     */
    public LanguageResult waitUntilFinished(long pollingIntervalSeconds, long timeoutSeconds) throws DocAIClientException, DocAIApiException, InterruptedException {
     ...
     * @throws InterruptedException Thread interrupted during Thread.sleep()
     */
    public LanguageResult waitUntilFinished(long pollingIntervalSeconds, long timeoutSeconds, boolean showProgress) throws DocAIClientException, DocAIApiException, InterruptedException {
        return (LanguageResult) super.waitUntilFinished(pollingIntervalSeconds, timeoutSeconds, showProgress);
    }
}
