...
public class Field {
   ...
   */
  public static FieldListElement[] listFields(DocAIClient client)
  ...
  public FieldMetadata getMetadata() throws DocAIClientException, DocAIApiException {
    return client.authorizedGet(
        String.format("api/v2/fields/%s/metadata", fieldId), 200, FieldMetadata.class);
  }
  ...
  public FieldAccuracy getAccuracy() throws DocAIClientException, DocAIApiException {
    return client.authorizedGet(
        String.format("api/v2/fields/%s/accuracy", fieldId), 200, FieldAccuracy.class);
  }
  ...
  public FieldValidation[] getValidationDetails() throws DocAIClientException, DocAIApiException {
    return client.authorizedGet(
        String.format("api/v2/fields/%s/validation-details", fieldId),
        200,
   ...
   * @throws DocAIClientException Error preparing, sending or processing the request/response
   */
  public static Field createField(DocAIClient client, String name, String description)
      throws DocAIClientException, DocAIApiException {
    CreateFieldResponse response =
        client.authorizedJsonRequest(
            "POST",
            "api/v2/fields",
