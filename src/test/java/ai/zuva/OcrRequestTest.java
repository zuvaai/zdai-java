...
class OcrRequestTest {
    ...
    void ocrTest(WireMockRuntimeInfo wmRuntimeInfo) throws Exception {
        ...
        OcrRequest request = OcrRequest.createRequest(client, new ZdaiFile(client, fileId));
        ...
        stubFor(get("/api/v2/ocr/" + requestId + "/text")
        ...
        stubFor(get("/api/v2/ocr/" + requestId + "/images")
        ...
        stubFor(get("/api/v2/ocr/" + requestId + "/layouts")
